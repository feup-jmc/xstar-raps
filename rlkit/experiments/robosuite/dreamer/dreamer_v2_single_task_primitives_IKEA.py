...
from rlkit.torch.model_based.dreamer.experiments.kitchen_dreamer_IKEA import experiment
...
if __name__ == "__main__":
    ...
    parser.add_argument("--exp_prefix", type=str, default="IKEAtest")   #keep and port
    parser.add_argument("--num_seeds", type=int, default=1)             #remove multiple seed funct.
    parser.add_argument("--mode", type=str, default="here_no_doodad")   #will bypass with here_no_doodad as is always the case
    parser.add_argument("--env", type=str, default="IKEA")              #handled by scparse
    parser.add_argument("--debug", action="store_true", default=True)   #keep and port
    ...
    variant = dict(
        ...
        env_name="table_lack_0825",                                                #using table_lack ok here? 
        use_raw_actions=False,
        env_suite="IKEA",                                          #is it fine with using IKEA here?
        env_kwargs=dict(
            robots="Sawyer",                                             #probably ok with sawyer, will it get confused between source?
            has_renderer=False,
